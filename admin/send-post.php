...
<?php
  ...
  if(isset($_POST["post"])){
    ...
    $sql = "INSERT INTO post(userID,post) VALUES('$uid','$content')";
          ...
          <div class="container">
              ...
              <div class="collapse navbar-collapse">
                  <ul class="nav navbar-nav navbar-right">
                      ...
                      <li class="active"><a href="send-post.php">Post</a></li>
                               ...
                               <div class="form-input">
                                 <form id="post-form" name="post-form" method="post">
                                   <div class="form-group">
                                     <textarea name="content" id="message" required="required" class="form-control" rows="8" placeholder="Your text here"></textarea>
                                   </div>
                                   <div class="form-group">
                                     <input type="submit" name="post" class="btn btn-submit" value="Post">
                                   </div>
                                 </form>
                               </div>
                             </form>
